...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-wesell-api-local-7x91zf_!wu7s(ir^hvu&=d4z!@u%m#kq8qz",
)
...
# Public base URL used to build absolute media links in API responses
# when running behind a proxy. Falls back to the incoming request host.
